...
export var Input = function (props) {
    var _a;
    // 取出属性
    var disabled = props.disabled, size = props.size, icon = props.icon, prepend = props.prepend, append = props.append, style = props.style, children = props.children, restProps = __rest(props
    //根据属性计算不同的className
    , ["disabled", "size", "icon", "prepend", "append", "style", "children"]);
    //根据属性计算不同的className
    ...
    React.createElement("div", { className: classes, style: style },
        ...
        React.createElement("input", __assign({ className: "vinking-input-inner", disabled: disabled }, restProps)),
